            ...
            <div className="container">
                <div className="row g-4">
                    ...
                    <div className="col-lg-4">
                        <div className="h-100 bg-light rounded d-flex align-items-center p-5 card">
                            ...
                            <div className="ms-4">
                                ...
                                <h5 className="mb-0 text-white card-text"><a href="tel:9595703307">9595703307</a></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="h-100 bg-light rounded d-flex align-items-center p-5 card">
                            ...
                            <div className="ms-4">
                                ...
                                <h5 className="mb-0 card-text"><a href="mailto:paarasmanihospital20@gmail.com">paarasmanihospital20@gmail.com</a></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div className="bg-light rounded p-5 card">
                            ...
                            <form action="" method="post" className='card'>
                                <div className="row g-3 card">
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <input type="text" name="mobile" className="form-control" id="mobile" placeholder="Phone" />
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <textarea name="message" className="form-control" placeholder="Leave a message here" id="message" style={{ height: '100px' }}></textarea>
